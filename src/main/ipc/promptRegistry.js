...
const AGENT_TOOL_SPECS = [
    ...
    {name: "get_library_overview", label: "资料库概览", category: "library", argsExample: "{}", description: "读取资料库概览。", prefetchable: true},
    {name: "search_library", label: "搜索资料库", category: "library", argsExample: "{\"query\":\"keyword\"}", description: "搜索资料库，返回命中文件与片段。", prefetchable: true},
    {name: "read_library_file", label: "读取资料文件", category: "library", argsExample: "{\"path\":\"relative path or file name\"}", description: "读取资料文件正文。"},
